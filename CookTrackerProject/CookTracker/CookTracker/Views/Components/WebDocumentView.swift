    ...
    private func getTermsOfServiceHTML() -> String {
        ...
        <body>
            <div class="container">
                ...
                <h2>第1条（適用）</h2>
                <p>本規約は、株式会社CookTracker（以下「当社」）が提供するCookTrackerアプリケーション（以下「本アプリ」）の利用条件を定めるものです。ユーザーの皆様（以下「ユーザー」）には、本規約に従って本アプリをご利用いただきます。</p>
                ...
                <h2>第4条（知的財産権）</h2>
                <p>本アプリに関する知的財産権は全て当社に帰属します。ユーザーは、本アプリを利用する権利のみを有し、所有権を取得するものではありません。</p>
                <p>ユーザーが本アプリに投稿したコンテンツの著作権は、ユーザーに帰属します。</p>

                <h2>第5条（プライバシー）</h2>
                <p>当社は、ユーザーのプライバシーを尊重し、個人情報の取り扱いについては別途定めるプライバシーポリシーに従います。</p>
                ...
                <p>本アプリは「現状有姿」で提供され、当社は本アプリの完全性、正確性、確実性について保証しません。</p>

                <h2>第7条（サービスの変更・終了）</h2>
                <p>当社は、ユーザーに事前に通知することなく、本アプリの内容を変更し、または本アプリの提供を終了することができます。これらによってユーザーに生じた損害について、当社は一切の責任を負いません。</p>

                <h2>第8条（規約の変更）</h2>
                <p>当社は、必要と判断した場合には、本規約を変更することがあります。変更後の規約は、本アプリ内または当社ウェブサイトで公表した時点から効力を生じます。</p>
    ...
    private func getPrivacyPolicyHTML() -> String {
        ...
        <body>
            <div class="container">
                ...
                <div class="highlight">
                    <p><strong>お客様のプライバシーを保護することは、当社にとって非常に重要です。</strong>本ポリシーでは、CookTrackerアプリにおける個人情報の取り扱いについて詳しく説明します。</p>
                </div>

                <h2>1. 基本方針</h2>
                <p>株式会社CookTracker（以下「当社」）は、お客様の個人情報の保護に関して、以下の基本方針に基づいて取り組んでいます：</p>
                <ul>
                ...
                <h2>4. データの保存・管理</h2>
                <p><strong>ローカル保存：</strong>お客様のレシピ情報、調理記録、写真等は、お客様のデバイス内にローカル保存されます。これらのデータは当社のサーバーに送信されることはありません。</p>
                ...
                <h2>8. 子どもの個人情報</h2>
                <p>当社は、13歳未満の子どもから意図的に個人情報を収集することはありません。13歳未満の子どもが個人情報を提供したことを知った場合、速やかにその情報を削除いたします。</p>

                <h2>9. プライバシーポリシーの変更</h2>
                <p>当社は、法令の変更やサービス内容の変更に伴い、本ポリシーを変更することがあります。変更は、アプリ内での通知または当社ウェブサイトでの公表により効力を生じます。</p>
